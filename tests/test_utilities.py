...
def test_estrutura_pastas():
    ...
    pastas_obrigatorias = ["arquivos", "arquivos/ODs"]
...
def test_arquivos_exemplo():
    ...
    arquivos_exemplo = ["arquivos/DECUPAGEM.csv", "arquivos/PLANO_FINAL.pdf"]
...
def test_validar_estrutura_dados_entrada(gerador_teste):
    ...
    # Dados válidos
    dados_validos = {
        "cenas_por_dia": {"1": ["001", "002"], "2": ["003", "004"]},
        "dados_cenas": {
...
def test_verificar_dependencias_sistema():
    ...
    dependencias_obrigatorias = ["pandas", "openpyxl", "pdfplumber"]
